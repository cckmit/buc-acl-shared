...
/**
 * 封装数据权限相关常量
 * 类DataPermissionConstaints.java的实现描述：TODO 类实现描述 
 * @author tongxu 2015年11月4日 下午2:07:57
 */
public class DataPermissionConstaints {
    ...
    /**
     * 外部数据源返回结果中的canSelect默认值
     */
    public static final Boolean OUT_DATA_SOURCE_RESULT_CAN_SELECT_DEFAULT= true;
    ...
    /**
     * 外部数据源返回结果中的propertyName字段名
     */
    public static final String OUT_DATA_SOURCE_RESULT_PROPERTY_NAME = "propertyName";
    
    /**
     * 外部数据源返回结果中的hasChildren字段名
     */
    public static final String OUT_DATA_SOURCE_RESULT_PROPERTY_HAS_CHILDREN = "hasChildren";
    
    /**
     * 外部数据源返回结果中的hasChildren字段的是值
     */
    public static final Boolean OUT_DATA_SOURCE_RESULT_PROPERTY_HAS_CHILDREN_YES = true;
    
    /**
     * 外部数据源返回结果中的hasChildren字段的否值
     */
    public static final Boolean OUT_DATA_SOURCE_RESULT_PROPERTY_HAS_CHILDREN_NO = false;
    ...
    /**
     * 外部数据源使用的当前请求类型，
     * forQuery代表本次查询是根据关键字查数据
     * forDetail代表要根据“id”查数据
     * forApproval代表要根据“id”查审批人
     */
