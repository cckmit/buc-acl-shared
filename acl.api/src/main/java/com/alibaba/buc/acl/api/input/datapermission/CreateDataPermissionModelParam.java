...
@GroupSequence(
               value = {
                       ...
                       S2.class,
                       Oper.class,
                       CreateDataPermissionModelParam.class
               }
       )
...
@AppKeyPrivilegeAnnotation(
        ...
        interfaceNameField = "DataPermissionModelService.createDataPermissionModel",
        groups = {Sa1.class}
)

/**
 * 封装数据权限模型创建参数
 * 类CreateDataPermissionModelParam.java的实现描述：TODO 类实现描述 
